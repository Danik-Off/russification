...
- [~] 956 — `simple_mobs` — переведено 288 (предметы, мобы, боссы, эффекты, достижения, подсказки, ВСЕ диалоги NPC). Осталось только техническое: внутренние имена частиц/эффектов, яйца призыва внутренних сущностей, пустые субтитры
- [x] 70 — `quest_giver` (диалоги жителей-квестодателей: реплики согласия/отказа, сообщения, контракты, имена)
